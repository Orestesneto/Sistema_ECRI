...
function renderizarFotoPequenaSituacao(item) {
    ...
    return `<img src="${escapeAttr(foto)}" alt="Foto de ${escapeAttr(item?.nome_completo || '')}" class="foto-clickable" title="Clique para ampliar" style="width:40px; height:40px; border-radius:50%; object-fit:cover; cursor:pointer;" onclick="abrirModalFotoGrande(this.src)" onerror="tratarErroFotoDirigente(this)">`;
}
